      							...
      							<%
							        ...
							        <%}else if(session.getAttribute("kind").equals("admin")){%>
							            ...
							            <input type="button" name = ""  value="관리자페이지" onclick="location.href='/admin/admin.jsp'"/>
											...
											<%
							     		}else if(session.getAttribute("kind").equals("client")){%>
							     		<div align="left">
							            <input type="button" name = ""  value="내 쿠폰정보확인" onclick="location.href='/client/clientStamp.jsp'"/>
							      		</div>
							     		<%
							     		}
							        }
