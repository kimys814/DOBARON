...
<center>
  <form action="Somae_2.jsp" method="post" name="newid">
 
 <table border="0" cellpadding="0" cellspacing="0" width="600">
<tr>
<td align="center" width=600 colspan=4>
 <font face='굴림' size=5>커피점(소매)회원 가입신청서 양식</font><br><BR></td></tr>
<tr>
...
<td width='120' nowrap style="padding-left:15px" bgcolor=#eef0f4 height=30>상호</td>
 ...
 <font size=3 face='굴림체'>
 <input type=text name="id" value="" maxlength=16 style="width:122px" onfocus="window.open('../admin/idcheck.jsp','zip','left=100,top=100,width=300,height=200');document.newid.passwd1.focus();" readonly></font><br>
 </td>
 ...
 <tr>
  ...
  <a href="javascript:popaddress()"><input type=button name="bt" onclick='popaddress(this.value)' value="찾기" style="width:60px"></a>
