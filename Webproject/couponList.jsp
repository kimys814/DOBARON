...
<div class="container" style="filter:alpha(opacity=100)" align="center">
  ...
  <div class="header" style="filter: alpha(opacity=100); font-family: Tahoma, Geneva, sans-serif; font-size: small; color: #FFF;">
  		...
  		<h1 align="center" >
            ...
            <a href="/coupon/FindClientStamp.jsp"><font color="#BBBBBB">쿠폰입력</font></a>&nbsp;&nbsp;&nbsp;
           	<a href="/couboard/shopBoard.jsp"><font color="#BBBBBB">게시판</font></a>&nbsp;&nbsp;&nbsp;
            <a href="/selectSomae/couponList.jsp"><font color="#66FFCC">쿠폰내역조회</font></a>&nbsp;&nbsp;&nbsp;
  	...
  	<div class="content" align="center" >
   		...
   		<iframe src="../selectSomae/selectSomae_1.jsp" style="background-color:#828282;" align="top" width="950px" height="450px" scrolling="auto" frameborder="0"></iframe>
